...
class TestPyuppsala(PyuppsalaNoSchemaValidation, TestLxml):
    ...
    test_fuzz_network_link_control = settings(
        suppress_health_check=[HealthCheck.differing_executors],
    )(TestLxml.test_fuzz_network_link_control)
    test_fuzz_update = settings(
        suppress_health_check=[HealthCheck.differing_executors],
    )(TestLxml.test_fuzz_update)
    test_fuzz_update_with_change = settings(
        suppress_health_check=[HealthCheck.differing_executors],
    )(TestLxml.test_fuzz_update_with_change)
    test_fuzz_network_link_control_with_update = settings(
        suppress_health_check=[HealthCheck.differing_executors],
    )(TestLxml.test_fuzz_network_link_control_with_update)
