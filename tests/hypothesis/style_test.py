...
class TestPyuppsala(PyuppsalaNoSchemaValidation, TestLxml):
    ...
    test_fuzz_style_url = settings(
        suppress_health_check=[HealthCheck.differing_executors],
    )(TestLxml.test_fuzz_style_url)
    test_fuzz_hot_spot = settings(
        suppress_health_check=[HealthCheck.differing_executors],
    )(TestLxml.test_fuzz_hot_spot)
    test_fuzz_icon_style = settings(
        suppress_health_check=[HealthCheck.differing_executors],
    )(TestLxml.test_fuzz_icon_style)
    test_fuzz_line_style = settings(
        suppress_health_check=[HealthCheck.differing_executors],
    )(TestLxml.test_fuzz_line_style)
    test_fuzz_poly_style = settings(
        suppress_health_check=[HealthCheck.differing_executors],
    )(TestLxml.test_fuzz_poly_style)
    test_fuzz_label_style = settings(
        suppress_health_check=[HealthCheck.differing_executors],
    )(TestLxml.test_fuzz_label_style)
    test_fuzz_balloon_style = settings(
        suppress_health_check=[HealthCheck.differing_executors],
    )(TestLxml.test_fuzz_balloon_style)
    test_fuzz_style = settings(
        suppress_health_check=[HealthCheck.differing_executors],
    )(TestLxml.test_fuzz_style)
    test_fuzz_styles_no_icon_style = settings(
        suppress_health_check=[HealthCheck.differing_executors],
    )(TestLxml.test_fuzz_styles_no_icon_style)
    test_fuzz_pair = settings(
        suppress_health_check=[HealthCheck.differing_executors],
    )(TestLxml.test_fuzz_pair)
    test_fuzz_style_map_one_pair = settings(
        suppress_health_check=[HealthCheck.differing_executors],
    )(TestLxml.test_fuzz_style_map_one_pair)
    test_fuzz_style_map_pairs = settings(
        suppress_health_check=[HealthCheck.differing_executors],
    )(TestLxml.test_fuzz_style_map_pairs)
